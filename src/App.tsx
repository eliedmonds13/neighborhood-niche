          ...
          <section style={{
            ...
            <div style={{
              ...
              <div style={{ fontSize: '0.81rem', lineHeight: 1.9, color: T.inkLight }}>
                ...
                <p style={{ marginTop: 14 }}>For Eli, the inspiration for the project came when he found a tiny window deli on 14th Street selling $3 empanadas. It quickly became a regular lunch spot and sparked a curiosity about overlooked neighborhood spots hidden just blocks from school. For Emmett, the inspiration came from his first visit to Pizzazz, a local pizza shop where the owner welcomed him with an unusual warmth and generosity. He immediately wanted to learn the story behind the business and find others like it.</p>
